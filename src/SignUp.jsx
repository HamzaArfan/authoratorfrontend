...
const Signup = () => {
  ...
  // Function to clear all relevant localStorage data on signup
  const clearLocalStorageData = () => {
    ...
    console.log('Local storage data cleared on signup');
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Clear any existing local data before setting user data
        ...
        // Set flag to ensure default tab after signup
